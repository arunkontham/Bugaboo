///////////////////////////////////////////////////////////////////////////////////
//                                                                               //
// C++ Using Arduino IDE V1.8.99.0                                               //
//                                                                               //
// Manufacture Name       - Bugaboo                                              //
// Manufacture Product    - Air Quality Monitor                                  //
// Communication Protocol - BLE Bluetooth Low Energy Device                      //
//                        - BLE Manufacturer Expressif ESP32                     //
//                        - BLE Broadcast SSI as "Bugaboo-AQM"                   //
// Firmware Description                                                          //
// ====================                                                          //
// Establishes connection between the ESP32 microcontroller and the sensors      //
// [Air Quality Monitor Humidity Sensor (AQM) and Digital Humidity Sensor        //
// (DHT20)] using Bluetooth Low Energy protocol(BLE) based on agreed criteria.   //
// The AQM provides the air quality readings while the SHTC3 provides the        //
// humidity and temperature reading. The ESP32 outputs a JSON string to          //
// listening devices in the following format:                                    //
// JSON String: "pm1:99,pm25:99,pm10:99,AirQ:999,voc:9.9,Percent:100,temp:99,    //
// humidity:99,DevM:ACT"                                                         //
// The 1st reversion sends the data unencrypted.                                 //
// The BLE server also reads data being sent from the connected device through   //
// the serial bus.                                                               //
// The connected device can send JSON String commands to the BLE server.         //
// The firmware manages the battery life by two modes                            //
//     (1)-By assessing the battaery level and turning "on" or "off" the AQM     //
//     (2)-By receiving power mode commands from the connected device            //
//                                                                               //
//                                                                               //
// V1.00 - Changes                                                               //
// =====                                                                         //
// Manufacture Prototype for verification & testing                              //
//                                                                               //
///////////////////////////////////////////////////////////////////////////////////
//               Copy Rights - Chill Baby Technologies, LLC                      //
///////////////////////////////////////////////////////////////////////////////////

///////////////////////////////////////////////////////////////////////////////////
// ESP32  Bluetooth Low Energy Libraries                                         //
///////////////////////////////////////////////////////////////////////////////////
#include <BLEDevice.h>
#include <BLEUtils.h>
#include <BLEServer.h>
...
int led2 = millis();
///////////////////////////////////////////////////////////////////////////////////
// Establishing BLE UUID - Set of random characters to broadcast CBT binding     //
///////////////////////////////////////////////////////////////////////////////////
#define BugabooAQIService_UUID      "5f65689c-b01a-11ec-b909-0242ac120002"       // Unique Identifiers for Bugaboo Air Quality Indicator services and characteristics
#define BugabooAQISensorData_UUID   "5f656b6c-b01a-11ec-b909-0242ac120002"       // Characteristics for sensor data and device status info
#define BugabooAQIStatusInfo_UUID   "5f657044-b01a-11ec-b909-0242ac120002"
#define BugabooAQIFan_UUID          "2aaed5c4-7087-11ed-a1eb-0242ac120002"       // Characteristic for Fan Control
#define BugabooAQIFirmwareInfo_UUID "5f657666-b01a-11ec-b909-0242ac120002"       // Characteristic for firmware version
#define BugabooAQIMacAddress_UUID   "5f657922-b01a-11ec-b909-0242ac120002"       // Characteristic for device MAC Address
#define BugabooAQIOTAEnable_UUID    "5f657a62-b01a-11ec-b909-0242ac120002"       // Characteristic for OTA
#define BugabooAQIWiFi_UUID         "5f657c10-b01a-11ec-b909-0242ac120002"       // Characteristics for Wifi SSID info
#define BugabooAQICanopy_UUID       "5f657d78-b01a-11ec-b909-0242ac120002"

BLEServer* pServer = NULL;  // Initializing the BLE server.
BLECharacteristic *pBugabooAQISensorData;  // Initializing characteristic instances for use in all functions
BLECharacteristic *pBugabooAQIStatusInfo;
BLECharacteristic *pBugabooAQIFan;
BLECharacteristic *pBugabooAQIFirmwareInfo;
BLECharacteristic *pBugabooAQIMacAddress;
BLECharacteristic *pBugabooAQIOTAEnable;
BLECharacteristic *pBugabooAQIWiFi;
BLECharacteristic *pBugabooAQICanopy;
/**
 * @brief Counter for the number of consecutive readings above 25
 */
int counter = 0;
bool DebugMode = false;  // Sets debug mode to off
bool deviceConnected = false;  // Reset all device connections
bool oldDeviceConnected = false;
bool DeviceValid = true; // check correct password from client
bool ShouldSleep = false;
bool SleepCycleOrder = true;
bool Sleeping = false;
...
bool WakeDelay = false;
///////////////////////////////////////////////////////////////////////////////////
// ChillBaby Library for Voltage Level/Percentage & Air Quality Calculations     //
///////////////////////////////////////////////////////////////////////////////////
#include "Battery.h"
#include "AirQuality.h"
///////////////////////////////////////////////////////////////////////////////////
// AQI Temp and Humidity Sensor Libraries                                        //
///////////////////////////////////////////////////////////////////////////////////
#include "Adafruit_SHTC3.h"
Adafruit_SHTC3 shtc3 = Adafruit_SHTC3();
#include "PMS.h"                                                                 // Library for AQM sensor 
Adafruit_PM25AQI aqi = Adafruit_PM25AQI();                                       // Sensor initialization

///////////////////////////////////////////////////////////////////////////////////
// ESP32  OTA WiFi Parameters                                                    //
///////////////////////////////////////////////////////////////////////////////////
#include <WiFi.h>
...
const char *host = "Bugaboo-AQM";
const char *local_name = "esp32";
String WiFi_SSID;
String WiFi_PW;
const char *ssid;
const char *pw;
...
///////////////////////////////////////////////////////////////////////////////////
const int US_TRIG = 26;    // Trigger
const int US_ECHO = 25;    // Echo
...
const int PM050 = 19;
const int FAN1_PWM = 18;
const int FAN1_FG = 4;
const int IO0 = 2;
const int FAN2_PWM = 33;
const int FAN2_FG = 25;
const int Stdby = 14;
const int Charg = 27;
int US;
int Charge_State;
...
int pTime;
int qTime;
std::string DevName = "Bugaboo-AQM";  // Device name
std::string batMode = "ACT";  // Place holder to indicate device operation mode, based on battary level
std::string PassWord = "CBT"; // Hardcoded password
const int freq = 25000;
const int Fan1_Channel = 0;
const int Fan2_Channel = 2;
...
int air_q = 0;  // Air quality measurement value
float adj_air_q = 0;
float mybv = 0; // Gets battery voltage reading
bool myload =false;
int mybp = 0; // Gets current battery charge percantage
String str = "";
String str2 = "";
long sTime = 0;
long aTime = 0;
...
unsigned int pm2_5_int = 0;
unsigned int pm2_5 = 0;
float pm2_5_flt = 0;
unsigned int pm10 = 0;
int DataUpdateTime = 2000;
...
void BT() {
  if (deviceConnected == true) leds[9] = CRGB::White;
  else leds[9] = CRGB::Black;
}

void Child() {
  if (US < 25 || US > 600) leds[10] = CRGB::White;
  else leds[10] = CRGB::Black;
}

void Fan() {
  if (Fan_Mode > 0) {
    leds[11] = CRGB::White;
  } else leds[11] = CRGB::Black;
}

void Bat(int level) {
  if (digitalRead(Charg) == LOW && level < 100) {
    if (Color != "White") {
      leds[8] = CRGB::White;
      Color = "White";
    } else { 
...
void adjAQS(int aAQ) {
  ...
  } else if (aAQ > 50 && aAQ < 100) {
    leds[2] = leds[3] = CRGB::Orange;
  } else if (aAQ > 100) {
    leds[2] = leds[3] = CRGB::Maroon;
  }
  } else leds[2] = leds[3] = CRGB::Black;
}

void rawAQS(int rAQ) {
  if (US < 25 || US > 600) {
    if (rAQ < 50) {
    leds[0] = leds[1] = leds[4] = leds[5] = leds[6] = leds[7] = CRGB::Green;
  } else if (rAQ > 50 && rAQ < 100) {
    leds[0] = leds[1] = leds[4] = leds[5] = leds[6] = leds[7] = CRGB::Orange;
  } else if (rAQ > 100) {
    leds[0] = leds[1] = leds[4] = leds[5] = leds[6] = leds[7] = CRGB::Maroon;
  }
  } else leds[0] = leds[1] = leds[4] = leds[5] = leds[6] = leds[7] = CRGB::Black;
}
...
/**
 * @brief Gets a delayed reading from the IR sensor
 * 
 * @return The current reading from the IR sensor, after applying the delay
 *         behavior described in the question.
 */
int readUS() {

  int new_reading = get_IR_reading();
  if (new_reading > 25) {
    counter++;
  } else {
    counter = 0;
...
///////////////////////////////////////////////////////////////////////////////////
// Class Description:                                                            //
//  BLE Event Handler Class to respond to connection, disconnection, write and   //
//  read events to a characteristic.                                             //
///////////////////////////////////////////////////////////////////////////////////

class MyServerCallbacks: public BLEServerCallbacks { // Default functions to execute on connect/disconnect
...
class BugabooAppCallbacks: public BLECharacteristicCallbacks {                        // Adding device response to bluetooth connection events
    void onWrite(BLECharacteristic *pBugabooAQIStatusInfo) {                          // Client write event response to status characteristic

      std::string value = pBugabooAQIStatusInfo->getValue();                          // Read what the client sent
      if (DeviceValid) {                                                                  // Check Device has been authenticated before accepting any values
        if (value.length() > 0) {                                                         // Check for a non-null value.
          if (value == "ACT" || value == "BGD") {     // Check for accepted values
            batMode = value;                                                              // Sets the device mode.
            if (value == "ACT") {
              if (Sleeping == true) {
                Sleep = false;
               // pinMode(16, INPUT_PULLUP);
                ...
                while (!Serial2) {
                  delay(500);
                  Serial.println("Serial2 Port is not ready !");
                }
                digitalWrite(PM_EN, HIGH);
                delay(1000);
                digitalWrite(PM050, LOW);
                delay(500);
                digitalWrite(PM050, HIGH);
                delay(500);
                while(!aqi.begin_UART(&Serial2))
                {
                  Serial.println("PM25 Sensor did not reconnected !");
                  delay(500);
                }
                Background = false;
               
                Serial.println("APP: Changing to Active mode from sleep");
                Sleeping = false;
              }
              ShouldSleep = false;
              Serial.print("ShouldSleep set to false");
              Background = false;
            }
            if (value == "BGD") {
              //SleepCycleOrder=true;
              Serial.println("APP: Background Mode Activated");
              Background = true;
              SleepTime = 75000;
            }
            Serial.println("battery mode ="); Serial.println(batMode.c_str());            // Output the set mode on serial bus
            //delay(5000);                                                                  // wait 5s
          }
          else {
            Serial.println("Battery Mode not valid");                                     // Output response when invalid input is detected
            pBugabooAQIStatusInfo->setValue(batMode.c_str());                         // Resets characteristic to previous value
          }

        };
      } else pBugabooAQIStatusInfo->setValue("Please Authenticate Device");           // If Device not authenticated, ask for authentication
    }
};

class BugabooWiFiCallbacks: public BLECharacteristicCallbacks {
    void onWrite(BLECharacteristic *pBugabooAQIWiFi) {
      std::string Temp1 = pBugabooAQIWiFi->getValue();
      String g = Temp1.c_str();
      int index = g.indexOf(',');
      int leng = g.length();
      WiFi_SSID = g.substring(0, index);
      WiFi_PW = g.substring(index + 1, leng);
      Credentials.putString("SSID", WiFi_SSID);
      Credentials.putString("PW", WiFi_PW);
      Serial.println("WiFi Credentials changed by app!");
      Serial.print("SSID: "); Serial.println(WiFi_SSID);
      Serial.print("PW: "); Serial.println(WiFi_PW);
    }
};

class BugabooFanCallbacks: public BLECharacteristicCallbacks {
    void onWrite(BLECharacteristic *pBugabooAQIFan) {
      std::string Temp2 = pBugabooAQIFan->getValue();
      const char * e = Temp2.c_str();
      if (air_q < 50) {
      Auto = false;
      Fan_Mode = atoi(e);
      Serial.println("Fan mode changed by app!");
      Serial.print("Fan mode: "); Serial.println(Fan_Mode);
      } else Serial.println("Fan mode change not allowed, AQS is above 50");
    }
};

class BugabooCanopyCallbacks: public BLECharacteristicCallbacks {
    void onWrite(BLECharacteristic *pBugabooAQICanopy) {
      std::string Temp3 = pBugabooAQICanopy->getValue();
      const char * h = Temp3.c_str();
      Canopy = atoi(h);
      Serial.println("Canopy position changed by app!");
    }
};

///////////////////////////////////////////////////////////////////////////////////
//  Device initializaton on startup protocol                                     //
///////////////////////////////////////////////////////////////////////////////////
void setup() {
  leds[8] = CRGB::White;
  FastLED.show();    // Change 4
  Serial.begin(115200);
  ledcSetup(Fan1_Channel, freq, resolution);
  ledcAttachPin(FAN1_PWM, Fan1_Channel);
  ledcSetup(Fan2_Channel, freq, resolution);
  ledcAttachPin(FAN2_PWM, Fan2_Channel);
  ledcWrite(Fan1_Channel, 255);
  ledcWrite(Fan2_Channel, 255);
  int startup = millis();
  //while (millis() - startup < 5000) {
  //theaterChaseRainbow(50); 
  //}
  Credentials.begin("wifi", false);
  WiFi_SSID = Credentials.getString("SSID");
  WiFi_PW = Credentials.getString("PW");
  ...
  Serial.println("WiFi_PW: "); Serial.println(WiFi_PW);
  Serial.println("ssid: "); Serial.println(ssid);
  Serial.println("pw: "); Serial.println(pw);
  initWiFi();
  Serial.println("");
...
reset_system: // Initialization function
 ...
 // Serial2.begin(9600);
  ...
  pinMode(Charg, INPUT_PULLUP);
  pinMode(Stdby, INPUT_PULLUP);
  pinMode(US_TRIG, OUTPUT);
  pinMode(US_ECHO, INPUT);

  Serial2.begin(9600); // Open serial communication via UART on esp32

  pinMode(PM_EN, OUTPUT); 
  pinMode(PM050, OUTPUT);
  ...
  if (! aqi.begin_UART(&Serial2)) { // Connect to the sensor over hardware serial bus
    //Serial.println("Could not find PM 2.5 sensor!"); // Output error message when no sensor is detected
    if (DebugMode == false) goto reset_system; // Restart initialization
  }

  Serial.println("PM25 found!");  // Output message when sensor is detected
  Background = false;
  Sleep = false;
  
  BLEDevice::init(DevName.c_str()); // Initialize Bluetooth low energy device on esp32, called Bugaboo
  BLEServer *pServer = BLEDevice::createServer(); // Set up device as a server
  std::string MacAdd = (BLEDevice::getAddress().toString()); // Device mac address
  std::string MacIdent = MacAdd.substr(12);  // Last 4 digits of device mac address
  std::string DevFullName = DevName.append(MacIdent);  // Full device name, including the MAC address suffix
  DevFullName.erase(13, 1);
  esp_ble_gap_set_device_name(DevFullName.c_str());             // Function that sets device BLE Name

  pServer->setCallbacks(new MyServerCallbacks());  // Create Callback class
  BLEService *pBugabooAQIService = pServer->createService(BugabooAQIService_UUID); // Add Bugaboo air quality indicator service to server
  pBugabooAQISensorData = pBugabooAQIService->createCharacteristic(                // Add sensor data characteristic to AQI service
                            BugabooAQISensorData_UUID,                    // Properties of the characteristic
                            BLECharacteristic::PROPERTY_READ |
                            BLECharacteristic::PROPERTY_NOTIFY

                          );

  pBugabooAQIStatusInfo = pBugabooAQIService->createCharacteristic(                // Add device status info characteristic to AQI service
                            BugabooAQIStatusInfo_UUID,                    // Properties of the characteristic
                            BLECharacteristic::PROPERTY_READ |
                            BLECharacteristic::PROPERTY_WRITE

                          );

  pBugabooAQIFan = pBugabooAQIService->createCharacteristic(
                     BugabooAQIFan_UUID,
                     BLECharacteristic::PROPERTY_READ |
                     BLECharacteristic::PROPERTY_WRITE
  ...
  pBugabooAQIFirmwareInfo = pBugabooAQIService->createCharacteristic(              // Add firmware version characteristic to AQI service
                              BugabooAQIFirmwareInfo_UUID,
                              BLECharacteristic::PROPERTY_READ                         // Properties of the characteristic


                            );

  pBugabooAQIMacAddress = pBugabooAQIService->createCharacteristic(                // Add MAC Address characteristic to AQI service
                            BugabooAQIMacAddress_UUID,
                            BLECharacteristic::PROPERTY_READ                         // Properties of the characteristic


                          );

  pBugabooAQIWiFi = pBugabooAQIService->createCharacteristic(
                      BugabooAQIWiFi_UUID,
                      BLECharacteristic::PROPERTY_READ |
                      BLECharacteristic::PROPERTY_WRITE
  ...
  pBugabooAQICanopy = pBugabooAQIService->createCharacteristic(
                        BugabooAQICanopy_UUID,
                        BLECharacteristic::PROPERTY_READ |
                        BLECharacteristic::PROPERTY_WRITE
  ...
  pBugabooAQIStatusInfo->setCallbacks(new BugabooAppCallbacks());                  // Create new instance of callback class
  pBugabooAQIFan->setCallbacks(new BugabooFanCallbacks());
  pBugabooAQIWiFi->setCallbacks(new BugabooWiFiCallbacks());
  pBugabooAQICanopy->setCallbacks(new BugabooCanopyCallbacks());



  pBugabooAQIStatusInfo->setValue(batMode);                   // Default value and current syntax placeholder for status info
  pBugabooAQIFirmwareInfo->setValue("Firmware Version : 1.22.12.10");  // Firmware version
  pBugabooAQIMacAddress->setValue(DevFullName.c_str());  // MAC Address
  pBugabooAQIService->start();                              // Start service
  // BLEAdvertising *pAdvertising = pServer->getAdvertising();  // this still is working for backward compatibility
  //BLEAdvertisementData *pAdvertisementData;

  BLEAdvertising *pAdvertising = BLEDevice::getAdvertising();   // Initialize device advertising

  pAdvertising->addServiceUUID(BugabooAQIService_UUID);     // Add service uuid to advertising packet
  pAdvertising->setScanResponse(true);  // Become visible to others scans
  pAdvertising->setMinPreferred(0x06);  // Functions that help with iPhone connections issue
  pAdvertising->setMaxPreferred(0x12);
  //pAdvertising->setMinInterval(0x15);  // Functions that help with iPhone connections issue
...
///////////////////////////////////////////////////////////////////////////////////
// Description:                                                                  //
//  Device main operation, Loops thourgh until device is reset                   //
///////////////////////////////////////////////////////////////////////////////////
void loop() {
  //bool LastState = Sleep;
  server.handleClient();
  Serial.println(" ");
  mybv = Level(); // Gets battery voltage reading
  mybp = Percent(mybv,myload); // Gets current battery charge percantage
  US = readUS();
  BT();
  Child();
  Fan();
  adjAQS(adj_air_q);
  rawAQS(air_q);
  if (lTime == 0) lTime = millis();
  if (lTime - millis() > 1000) { 
   Bat(mybp);
   lTime = 0;
  }
...
//  } else if (mybp < 5) batMode = "SHD";
  ...
  if (!deviceConnected && oldDeviceConnected) {  // disconnecting
    ...
    Serial.println("start advertising"); // Output message on serial bus
    oldDeviceConnected = deviceConnected;
  }

  if (deviceConnected && !oldDeviceConnected) {  // connecting
    Serial.println("Device Connected"); // Output message on serial bus
    oldDeviceConnected = deviceConnected;
  }



  //if (mybp <= 5 && DebugMode == false){
  //  batMode = "SHD"; // force shutdown mode if battery percentage is 5% or lower
  //}
  //else if(mybp <= 20 && DeepSleep==false) {
  //  batMode = "LPM"; // force Low power mode if battery is between 20% and 5%
  //  DeepSleep=true;
  //}
  ...
  switch (Canopy) {
    case 1:
      adj_air_q = air_q * 0.75;
      break;
    case 2:
      adj_air_q = air_q * 0.55;
      break;
    case 3:
      adj_air_q = air_q * 0.45;
      break;
    case 4:
      adj_air_q = air_q * 0.30;
      break;
  }
  ...
  switch (Fan_Mode) {
    ...
    case 1:
     if(US < 25 || US > 600) {
        F1_Speed = 1;
        F2_Speed = 1;
        ledcWrite(Fan1_Channel, 191);
        ledcWrite(Fan2_Channel, 191);
     }
      break;
    case 2:
     if(US < 25 || US > 600) {
        F1_Speed = 2;
        F2_Speed = 2;
        ledcWrite(Fan1_Channel, 127);
        ledcWrite(Fan2_Channel, 127);
     }
      break;
    case 3:
     if(US < 25 || US > 600) {
        F1_Speed = 3;
        F2_Speed = 3;
        ledcWrite(Fan1_Channel, 63);
        ledcWrite(Fan2_Channel, 63);
     }
      break;
    case 4:
     if(US < 25 || US > 600) {
  ...
  if (Sleep) 
  {
    Serial.println("sleep variable = True");
  } else
  {
    Serial.println("sleep variable = false");
  } 
 
if ((US > 25 && US < 600) && (Sleep == false)) {
  Update_client(S1, US, F1_Speed, F2_Speed, pm1_0, pm2_5_flt, pm10, air_q, batMode.c_str(), mybp, Temp, Hum);
  Fan_Mode = 0;
  Canopy = 1;
  Sleep = true;
  WakeDelay = true;
  if (led2 == 0) led2  = millis();
  if (millis() - led2 > 30000) {
    leds[9] = CRGB::Black;
    leds[8] = CRGB::Black;
  }
    digitalWrite(PM050, LOW);
    delay(500);
    digitalWrite(PM_EN, LOW); 
    Serial2.end();
    pinMode(16, INPUT);
    pinMode(17, INPUT);
    //digitalWrite(16, LOW);
  ...
  Serial.println("Child not detected, entering sleep.");
  leds[9] = CRGB::White; // change 1
  leds[8] = CRGB::White; // change 2
  FastLED.show();        // change 3
} 
else if ((US < 25 || US > 600) && (Sleep == true)) {
  Sleep = false;
 // pinMode(16, INPUT_PULLUP);
  Adafruit_PM25AQI aqi = Adafruit_PM25AQI();
  Serial2.begin(9600);
  ...
  Background = false;
  Serial.println("PM25 Sensor woke up!");

}

 if (Background == false && (US < 25 || US > 600) && (batMode == "ACT" || batMode == "BGD") ) { // Only run if device is not in shut down mode
    if (batMode == "BGD") {
    if (aTime == 0) aTime = millis();
    if (aTime - millis() > 30000) {
      Background = true;
      aTime = 0;
    }
    }
    std::string Jstr = pBugabooAQISensorData->getValue(); // Store sensorData characteristic current value to a string for debugging
read_sensor:
    PM25_AQI_Data data;  // Read data from PM25 sensor

    if (!aqi.read(&data)) { // Check for data from sensor
      Serial.println("PM25 Sensor Reading Fail!");
      delay(500);  // Try again in a bit
    }
    else {
      if (data.framelen == 0x14) {
        pm1_0 = data.pm10_env;
        pm2_5 = data.pm25_env; 
        pm2_5_flt = pm2_5 + (random(0, 99) / 100);
        air_q = round(AQM(pm2_5_flt));
        pm10 = data.pm100_env;
        Serial.println("PM25 Sensor Reading Success!");
      }
      else {
        Serial.println("PM25 Sensor Reading Fail!");
      }
    ...
    Temp = Temp_adj(temp.temperature);
    Hum=humidity.relative_humidity;
    delay(500);
    
    if (air_q < 50 && Auto == true) {
      batMode = "BGD";
      Fan_Mode = 0;
    } else if (air_q > 50 && air_q < 60) {
      Auto = true;
      batMode = "ACT";
      Fan_Mode = 2;
    } else if (air_q > 60 && air_q < 100) {
      Auto = true;
      batMode = "ACT";
      Fan_Mode = 3;
    } else if (air_q > 100) {
    ...
    if (millis() - us > DataUpdateTime && batMode != "SHD") { // Run after set time and device is not in shut down mode
      Serial.print(F("PM 1.0: ")); Serial.print(pm1_0); // Print to usb serial for debugging
      Serial.print(F("\t\tPM 2.5: ")); Serial.print(pm2_5);
      Serial.print(F("\t\tPM 10: ")); Serial.print(pm10);
      Serial.print(F("\t\tTemperature: ")); Serial.print(Temp, 1); // print to usb serial for debugging
      Serial.print(F("\t\tHumidity: ")); Serial.println(Hum, 1);
      Serial.print(F("\t\tFan_Mode: ")); Serial.println(Fan_Mode);
      Serial.print(F("\t\tCanopy: ")); Serial.println(Canopy);
      Serial.print(F("\t\tMode: ")); Serial.println(batMode.c_str());
      Serial.print(F("\t\tCycles Count: ")); Serial.println(cycles);
      Serial.print(F("\t\tWakeDelay: ")); Serial.println(WakeDelay);
      if (Charge_State == LOW || mybp < 100) {
        Serial.print(F("\t\tDevice is Charging"));
      }
      else Serial.print(F("\t\tDevice is not Charging"));

      mybv = Level(); // call battery voltage function
      Serial.print("\t\tBat Voltage-->"); Serial.println(mybv); // Debugging print
      mybp = Percent(mybv, myload); // Call battery percentage function
      Serial.print("\t\tBat Percentage-->"); Serial.println(mybp);

      
      if (WakeDelay == true && (US < 25 || US > 600)) {
        if (led2 == 0) led2  = millis();
         Fan_Mode = 0;
         F1_Speed = 0;
         F2_Speed = 0;
...
//          } 
          ...
          Update_client(S1, US, F1_Speed, F2_Speed, pm1_0, pm2_5_flt, pm10, air_q, batMode.c_str(), mybp, Temp, Hum); // Function to send actual sensor data when operating in normal mode (Debug mode is off)
              us = millis();
              cycles = cycles+1;
    ...
    if (bTime == 0) bTime = millis();
    if (sTime == 0) sTime = millis();
    if (millis() - sTime > 1000) {
      Serial.println(" "); Serial.print("Device is Sleeping");
      sTime = 0;
    }
    if (bTime - millis() > SleepTime) {
      bTime = 0;
      Background = false;
    }
  }
...
///////////////////////////////////////////////////////////////////////////////////
// Description:                                                                  //
//  Function to control active and sleep operation of device based on times      //
//  passed to the function when called.                                          //
///////////////////////////////////////////////////////////////////////////////////
void AirQualitySensorSleepCycle(int SleepTime, int ActiveTime) { // Function that controls PM2.5 sensor active and sleep modes
  if (sTime == 0) sTime = millis();
  if (SleepCycleOrder == true) {                                // Check if in sleep segment of actice segment of cycle
    Serial2.end();
    pinMode(16, OUTPUT);
    pinMode(17, OUTPUT);
    digitalWrite(16, LOW);
    digitalWrite(17, LOW);
    digitalWrite(PM_EN, LOW);
    //digitalWrite(PM_EN, LOW);                                     // Put sensor into sleep mode
    SensorAwake = false;                                        // Change sensor state variable
    ShouldSleep = false;
    if (batMode == "BGD") Sleeping = true;
    if (batMode == "LPM") DeepSleep = true;
    Serial.println("SleepCycle active, AQM Sensor is Off");
    if (millis() - sTime > SleepTime) {                         // See if sleep time has elapsed
      sTime = 0;                                         // reset timer
      SleepCycleOrder = false;                                  // Change cycle segmant

    }
  }
  if (SleepCycleOrder == false) {
    //digitalWrite(PM_EN, HIGH);                        // Turn sensor on
    digitalWrite(PM_EN, HIGH);
   // Adafruit_PM25AQI aqi = Adafruit_PM25AQI();
    Serial2.begin(9600);
    Serial.println("AwakeCycle active, AQM Sensor turning on for 30s");
    ShouldSleep = true;
    SleepCycleOrder = true;
    Serial.println("ShouldSleep set to true");
    aTime = millis();
    batMode = "ACT";
    Serial.println("Battery mode set to active");
  }
}

///////////////////////////////////////////////////////////////////////////////////
// Description:                                                                  //
//  Function to update the data characteristic with new sensor values and notify //
//  client if data has changed, concatinates JSON  string.                       //
///////////////////////////////////////////////////////////////////////////////////
void Update_client(unsigned int sensor_1, unsigned int sensor_2, unsigned int sensor_3, unsigned int sensor_4, float sensor_5, unsigned int sensor_6, unsigned int sensor_7, unsigned int sensor_8, String sensor_9, unsigned int sensor_10, unsigned int sensor_11, unsigned int sensor_12) {


  /*{\"pm1\":99, \"pm25\":99, \"pm10\":99, \"AirQ\":999, \"voc\":9.9, \"percent\":100 \"temp\":99, \"humidity\":99 \"DevM\":ACT} // concatinate sensor data into JSON string format, order is ->
    pm sensor 1 , pm sensor 2.5 , pm sensor 10, air quality, battery voltage, battery percentage, temperature, humidity, device mode. */


  str2 = "{\"S1\":";

  str2 = str2 + int(sensor_1) + ",\"IR\":";

  str2 = str2 + int(sensor_2) + ",\"F1\":";

  str2 = str2 + int(sensor_3) + ",\"F2\":";

  str2 = str2 + int(sensor_4) + ",\"PM1\":";

  str2 = str2 + int(sensor_5) + ",\"PM25\":";

  str2 = str2 + int(sensor_6) + ",\"PM10\":";

  str2 = str2 + int(sensor_7) + ",\"AQS\":";

  str2 = str2 + int(sensor_8) + ",\"Device Mode\":";

  str2 = str2 + '"' + sensor_9 + '"' + ",\"%\":";

  str2 = str2 + int(sensor_10) + ",\"Temp\":";

  str2 = str2 + int(sensor_11) + ",\"Humidity\":";

  str2.concat(sensor_12);

  str2 = str2 + "}";

  Serial.print("Data JSON String-->"); Serial.println(str2);                // Debugging print

  if (DeviceValid) {
    pBugabooAQISensorData->setValue(str2.c_str());                      // Update sensorData characteristic with new sensor values
    pBugabooAQISensorData->notify();                                    // Update client of new values if they have changed since last sent
    pBugabooAQIStatusInfo->setValue(batMode.c_str());
  }
}
...
int Temp_adj(int te) {
  ...
  int adj_tmp;
  if (cycles < 10) off = 0;
  else if (cycles >= 10 && cycles < 60) off = 1;
  else if (cycles >= 70 && cycles < 210) off = 2;
  else if (cycles >= 210 && cycles < 260) off = 3;
  else if (cycles >= 260 && cycles < 310) off = 4;
  else if (cycles >= 310 && cycles < 360) off = 5;
  else if (cycles >= 360 && cycles < 420) off = 6;
  else if (cycles >= 420 && cycles < 480) off = 7;
  else if (cycles >= 480) off = 8;
  adj_tmp = te - off;
  return(adj_tmp);
}

/**
 * @brief Puts the ESP32 into sleep mode for the specified duration
 * 
 * @param flag A flag indicating whether to turn off the LEDs when waking up
 * @param sleep_duration The duration of sleep in seconds
 */
void goToSleep(bool flag, int sleepDuration) {
